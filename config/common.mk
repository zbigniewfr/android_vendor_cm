...
ifneq ($(PRODUCT_DEFAULT_DEV_CERTIFICATE),build/target/product/security/testkey)
    ifneq ($(CM_BUILDTYPE), UNOFFICIAL)
        ...
        ifeq ($(CM_VERSION_MAINTENANCE),0)
            CM_DISPLAY_VERSION := ZygiROM-$(PRODUCT_VERSION_MAJOR).$(PRODUCT_VERSION_MINOR)
        else
            CM_DISPLAY_VERSION := ZygiROM-$(PRODUCT_VERSION_MAJOR).$(PRODUCT_VERSION_MINOR).$(CM_VERSION_MAINTENANCE)
        endif
    endif
endif
endif
